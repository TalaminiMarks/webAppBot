...
CREATE TABLE "new_Character" (
    ...
    "cooper" INTEGER NOT NULL DEFAULT 0,
...
INSERT INTO "new_Character" ("affiliation", "age", "armor", "baseRace", "createdAt", "currentHealth", "defect", "displacement", "gold", "id", "ideas", "initiative", "inspiration", "languages", "level", "levelUp", "maxHealth", "name", "perception", "personality", "previous", "proficiency", "role", "story", "subRace", "tendency", "updatedAt", "userId", "xp") SELECT "affiliation", "age", "armor", "baseRace", "createdAt", "currentHealth", "defect", "displacement", "gold", "id", "ideas", "initiative", "inspiration", "languages", "level", "levelUp", "maxHealth", "name", "perception", "personality", "previous", "proficiency", "role", "story", "subRace", "tendency", "updatedAt", "userId", "xp" FROM "Character";
