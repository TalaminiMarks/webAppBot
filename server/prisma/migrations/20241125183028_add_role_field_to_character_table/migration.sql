...
INSERT INTO "new_Character" ("affiliation", "age", "created_at", "defect", "gold", "health", "history", "id", "ideas", "languages", "name", "personality", "previous", "race", "xp") SELECT "affiliation", "age", "created_at", "defect", "gold", "health", "history", "id", "ideas", "languages", "name", "personality", "previous", "race", "xp" FROM "Character";
