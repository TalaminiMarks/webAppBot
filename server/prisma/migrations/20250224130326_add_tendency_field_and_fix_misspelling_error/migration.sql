...
INSERT INTO "new_Character" ("affiliation", "age", "armor", "baseRace", "createdAt", "currentHealth", "defect", "displacement", "gold", "id", "ideas", "initiative", "inspiration", "languages", "level", "levelUp", "maxHealth", "name", "perception", "personality", "previous", "proficiency", "role", "subRace", "updatedAt", "userId", "xp") SELECT "affiliation", "age", "armor", "baseRace", "createdAt", "currentHealth", "defect", "displacement", "gold", "id", "ideas", "initiative", "inspiration", "languages", "level", "levelUp", "maxHealth", "name", "perception", "personality", "previous", "proficiency", "role", "subRace", "updatedAt", "userId", "xp" FROM "Character";
