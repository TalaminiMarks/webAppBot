...
INSERT INTO "new_Character" ("affiliation", "age", "baseRace", "createdAt", "defect", "displacement", "gold", "history", "id", "ideas", "initiative", "inspiration", "languages", "name", "perception", "personality", "previous", "proficiency", "role", "subRace", "updatedAt", "userId", "xp") SELECT "affiliation", "age", "baseRace", "createdAt", "defect", "displacement", "gold", "history", "id", "ideas", "initiative", "inspiration", "languages", "name", "perception", "personality", "previous", "proficiency", "role", "subRace", "updatedAt", "userId", "xp" FROM "Character";
