...
INSERT INTO "new_Character" ("affiliation", "age", "armor", "baseRace", "createdAt", "currentHealth", "defect", "displacement", "gold", "history", "id", "ideas", "initiative", "inspiration", "languages", "maxHealth", "name", "perception", "personality", "previous", "proficiency", "role", "subRace", "updatedAt", "userId", "xp") SELECT "affiliation", "age", "armor", "baseRace", "createdAt", "currentHealth", "defect", "displacement", "gold", "history", "id", "ideas", "initiative", "inspiration", "languages", "maxHealth", "name", "perception", "personality", "previous", "proficiency", "role", "subRace", "updatedAt", "userId", "xp" FROM "Character";
